using MSHelper.Metrics.Prometheus.Internals;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;
using Prometheus;
using Prometheus.SystemMetrics;

namespace MSHelper.Metrics.Prometheus;

public static class Extensions
{
    public static IMSHelperBuilder AddPrometheus(this IMSHelperBuilder builder)
    {
