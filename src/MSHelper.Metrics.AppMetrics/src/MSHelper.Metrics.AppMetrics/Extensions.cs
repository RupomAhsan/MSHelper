...
using MSHelper.Metrics.AppMetrics.Builders;
...
namespace MSHelper.Metrics.AppMetrics;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddMetrics(this IMSHelperBuilder builder,
    ...
    public static IMSHelperBuilder AddMetrics(this IMSHelperBuilder builder, MetricsOptions metricsOptions,
