...
using MSHelper.WebApi.Exceptions;
using MSHelper.WebApi.Formatters;
using MSHelper.WebApi.Requests;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddWebApi(this IMSHelperBuilder builder, Action<IMvcCoreBuilder> configureMvc = null,
    ...
    public static IMSHelperBuilder AddErrorHandler<T>(this IMSHelperBuilder builder)
