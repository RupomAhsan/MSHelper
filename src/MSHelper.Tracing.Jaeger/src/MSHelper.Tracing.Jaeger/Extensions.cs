...
using MSHelper.Tracing.Jaeger.Builders;
using MSHelper.Tracing.Jaeger.Tracers;
using Jaeger;
...
namespace MSHelper.Tracing.Jaeger;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddJaeger(this IMSHelperBuilder builder, string sectionName = SectionName,
    ...
    public static IMSHelperBuilder AddJaeger(this IMSHelperBuilder builder,
    ...
    public static IMSHelperBuilder AddJaeger(this IMSHelperBuilder builder, JaegerOptions options,
        string sectionName = SectionName, Action<IOpenTracingBuilder> openTracingBuilder = null)
    {
        ...
        if (!options.Enabled)
        {
            var defaultTracer = MSHelperDefaultTracer.Create();
