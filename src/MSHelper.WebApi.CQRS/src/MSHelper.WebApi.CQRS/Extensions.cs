...
using MSHelper.WebApi.CQRS.Builders;
using MSHelper.WebApi.CQRS.Middlewares;
...
{
    public static IMSHelperBuilder AddInMemoryDispatcher(this IMSHelperBuilder builder)
    {
