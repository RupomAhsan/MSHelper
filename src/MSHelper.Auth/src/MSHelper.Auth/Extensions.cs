...
using System.Text;
using MSHelper.Auth.Handlers;
using MSHelper.Auth.Services;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddJwt(this IMSHelperBuilder builder, string sectionName = SectionName,
    ...
    private static IMSHelperBuilder AddJwt(this IMSHelperBuilder builder, JwtOptions options,
        Action<JwtBearerOptions> optionsFactory = null)
    {
