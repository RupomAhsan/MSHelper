using System;
using System.Linq;
using MSHelper.Discovery.Consul.Builders;
using MSHelper.Discovery.Consul.Http;
using MSHelper.Discovery.Consul.MessageHandlers;
using MSHelper.Discovery.Consul.Models;
using MSHelper.Discovery.Consul.Services;
using MSHelper.HTTP;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddConsul(this IMSHelperBuilder builder, string sectionName = SectionName,
    ...
    public static IMSHelperBuilder AddConsul(this IMSHelperBuilder builder,
    ...
    public static IMSHelperBuilder AddConsul(this IMSHelperBuilder builder, ConsulOptions options,
    ...
    public static void AddConsulHttpClient(this IMSHelperBuilder builder, string clientName, string serviceName)
    ...
    private static ServiceRegistration CreateConsulAgentRegistration(this IMSHelperBuilder builder,
