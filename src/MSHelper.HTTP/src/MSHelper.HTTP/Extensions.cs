...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddHttpClient(this IMSHelperBuilder builder, string clientName = "MSHelper",
        ...
        Action<IHttpClientBuilder> httpClientBuilder = null)
    {
        ...
        var clientBuilder = builder.Services.AddHttpClient<IHttpClient, MSHelperHttpClient>(clientName);
        httpClientBuilder?.Invoke(clientBuilder);

        if (options.RequestMasking?.Enabled == true)
        {
            builder.Services.Replace(ServiceDescriptor
                .Singleton<IHttpMessageHandlerBuilderFilter, MSHelperHttpLoggingFilter>());
        }
    ...
    public static void RemoveHttpClient(this IMSHelperBuilder builder)
    {
