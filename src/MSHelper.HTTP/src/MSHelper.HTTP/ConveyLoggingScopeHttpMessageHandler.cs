...
internal sealed class MSHelperLoggingScopeHttpMessageHandler : DelegatingHandler
{
    private readonly ILogger _logger;
    private readonly HashSet<string> _maskedRequestUrlParts;
    private readonly string _maskTemplate;

    public MSHelperLoggingScopeHttpMessageHandler(ILogger logger, HttpClientOptions options)
    {
