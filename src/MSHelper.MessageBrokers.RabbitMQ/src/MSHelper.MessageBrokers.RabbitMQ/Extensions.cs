...
using MSHelper.MessageBrokers.RabbitMQ.Clients;
using MSHelper.MessageBrokers.RabbitMQ.Contexts;
using MSHelper.MessageBrokers.RabbitMQ.Conventions;
using MSHelper.MessageBrokers.RabbitMQ.Initializers;
using MSHelper.MessageBrokers.RabbitMQ.Internals;
using MSHelper.MessageBrokers.RabbitMQ.Plugins;
using MSHelper.MessageBrokers.RabbitMQ.Publishers;
using MSHelper.MessageBrokers.RabbitMQ.Serializers;
using MSHelper.MessageBrokers.RabbitMQ.Subscribers;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddRabbitMq(this IMSHelperBuilder builder, string sectionName = SectionName,
    ...
    public static IMSHelperBuilder AddExceptionToMessageMapper<T>(this IMSHelperBuilder builder)
    ...
    public static IMSHelperBuilder AddExceptionToFailedMessageMapper<T>(this IMSHelperBuilder builder)
