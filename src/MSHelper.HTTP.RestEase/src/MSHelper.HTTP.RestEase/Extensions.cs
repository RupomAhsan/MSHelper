...
using MSHelper.HTTP.RestEase.Builders;
using MSHelper.HTTP.RestEase.Serializers;
using MSHelper.LoadBalancing.Fabio;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddServiceClient<T>(this IMSHelperBuilder builder, string serviceName,
    ...
    private static IMSHelperBuilder AddServiceClient<T>(this IMSHelperBuilder builder, string serviceName, 
        RestEaseOptions options, Action<IMSHelperBuilder> registerFabio)
        where T : class
    {
