using System;
using MSHelper.Swagger.Builders;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.OpenApi.Models;

namespace MSHelper.Swagger;
...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddSwaggerDocs(this IMSHelperBuilder builder, string sectionName = SectionName)
    {
    ...
    public static IMSHelperBuilder AddSwaggerDocs(this IMSHelperBuilder builder,
    ...
    public static IMSHelperBuilder AddSwaggerDocs(this IMSHelperBuilder builder, SwaggerOptions options)
    {
