...
public static class Extensions
{
    ...
    public static IMSHelperBuilder AddMSHelper(this IServiceCollection services, string sectionName = SectionName,
        IConfiguration configuration = null)
    {
        ...
        var builder = MSHelperBuilder.Create(services, configuration);
    ...
    public static IApplicationBuilder UseMSHelper(this IApplicationBuilder app)
    {
    ...
    public static TModel GetOptions<TModel>(this IMSHelperBuilder builder, string settingsSectionName)
        where TModel : new()
    {
